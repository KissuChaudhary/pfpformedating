...
import { Upload, X, Loader2, Camera, Sparkles, CheckCircle2, AlertCircle } from 'lucide-react';

type ModelMode = 'single';
...
export function CreateModelClient() {
    ...
    const modelMode: ModelMode = 'single';
            ...
            <div className="w-full max-w-lg">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-zinc-400 text-sm">
                        Upload reference photos to create your AI model
                    </p>
                </div>
                ...
                {/* Step 2 removed: gender selection is no longer needed */}
