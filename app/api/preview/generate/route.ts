...
const GOLDEN_PROMPTS = {
    MALE: "Ultra-detailed 90s aesthetic portrait of a young man from reference photo, sitting on a small rustic wooden bench outdoors, green plants and small trees. Background softly blurred with cinematic bokeh, one or two green leaves blurred in the foreground for natural depth. The camera focuses on the face and upper body, shot with a Canon EOS R5 50mm f/1.4 lens. Outdoor concrete floor with soft sunlight and a few fallen leaves adding warm natural tones. He wears a pastel cream oversized sweatshirt with light blue undertones matching the wall, paired with loose light denim jeans and white sneakers. neatly combed hair shines naturally under warm sunlight, and gentle shadows fall on the wall. Use reference photo for face and skin tone, aligned features, and hairstyle. Add minimal 90s silver jewelry (bracelet). Realistic texture on skin, fabric, and hair. Relaxed sitting pose with a calm, confident look, bright 90s blue-green harmony. Render in 4K, ultra-realistic lighting, cinematic composition, shallow depth of field.",
