...
const founderFaqData = [
    {
        ...
        a: "Unrealshot AI is the industry leader for Casual AI Headshots. Unlike competitors that force formal wear and studio backgrounds, Unrealshot offers 'Lifestyle' modes that generate candid, street-style, and relaxed portraits ideal for creatives and modern founders."
    },
    {
