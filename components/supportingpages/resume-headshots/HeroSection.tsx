  ...
  return (
    <section className="relative mx-auto pb-12 overflow-hidden min-h-screen bg-black">
      ...
      <div className="px-4 pt-[150px] max-w-6xl mx-auto text-center flex flex-col justify-center">
        <div className="relative z-10 space-y-6">
          ...
          <div className="flex sm:flex-row gap-2 justify-center items-center w-full relative">
            ...
            <Link href="#">
              <Button className="text-sm sm:text-md py-5 sm:py-6 group relative bg-white hover:bg-white/90 text-black rounded-md overflow-hidden cursor-pointer pr-12" onClick={(e) => {
                e.preventDefault();
      ...
      <VideoModal
        ...
        title="How It Works - Resume Headshots Demo"
      />
    </section>
  )
}