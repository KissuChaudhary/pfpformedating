          ...
          <div className="space-y-6">
            ...
            <h1 className="text-4xl sm:text-6xl max-w-4xl mx-auto font-bold leading-[1.1] mb-4 font-[var(--font-inter-tight)]">
              <span className="text-white">
                Professional AI Doctor Headshots That
              </span>
...
Project the compassion and professionalism you're known for. Get warm, high-quality AI headshots for your practice, hospital profile, or speaking engagements instantly.            </p>
          ...
          <div className="flex flex-col items-center space-y-2 pt-2">
            <div className="flex items-center space-x-2">
              <div className="flex -space-x-2">
                ...
                <div className="w-8 h-8 rounded-full bg-gray-900 border-2 border-white flex items-center justify-center">
                  <span className="text-white text-xs font-bold">300+</span>
                </div>
              </div>
            ...
            <p className="text-gray-400 text-md">Trusted by 300+ Medical Professionals</p>
          </div>
        </div>
      </div>
