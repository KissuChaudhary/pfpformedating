          ...
          <div className="space-y-6">
            ...
            <h1 className="text-4xl sm:text-6xl max-w-4xl mx-auto font-bold leading-[1.1] mb-4 font-[var(--font-inter-tight)]">
              ...
              <span className="text-[#ff6f00] ml-2">
                Ready for LinkedIn & Teams
              </span>
            </h1>

            <p className="text-lg text-gray-300 max-w-3xl mx-auto mb-8">
Present a credible, consistent brand across LinkedIn, Slack, and your company site. Get studio-quality AI headshots for the whole team—fast, affordable, and remarkably realistic.
            </p>
          </div>
