          ...
          <div className="space-y-6">
            ...
            <h1 className="text-4xl sm:text-6xl max-w-4xl mx-auto font-bold leading-[1.1] mb-4 font-[var(--font-inter-tight)]">
              <span className="text-white">
                AI Fantasy Photoshoot for
              </span>
              <span className="text-[#ff6f00] ml-2">
                 cosplay, editorials, and viral feeds
              </span>
            </h1>

            <p className="text-lg text-gray-300 max-w-3xl mx-auto mb-8">
Transform simple photos into high-fashion fantasy worlds. Get scroll-stopping portraits designed to showcase characters, campaigns, and your most imaginative looks.
            </p>
          </div>
