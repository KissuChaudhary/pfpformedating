          ...
          <div className="space-y-6">
            ...
            <h1 className="text-4xl sm:text-6xl max-w-4xl mx-auto font-bold leading-[1.1] mb-4 font-[var(--font-inter-tight)]">
              <span className="text-white">
                 Hauntingly Good AI Halloween Photoshoot, 
              </span>
...
Summon cinematic Halloween portraits—ghostly, glam, or gothic. Pick your vibe and get a hauntingly good set for costumes, parties, and social feeds.
            </p>
          </div>
