      ...
      <div className="px-4 pt-[150px] max-w-6xl mx-auto text-center flex flex-col justify-center">
        <div className="relative z-10 space-y-6">
          <div className="space-y-6">
            ...
            <h1 className="text-4xl sm:text-6xl max-w-4xl mx-auto font-bold leading-[1.1] mb-4 font-[var(--font-inter-tight)]">
              <span className="text-white">
                Create Your Digital Twin with our
              </span>
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto mb-8">
              Generate a realistic AI version of yourself and become a virtual influencer. Create stunning content, grow your audience, and explore new digital frontiers without ever leaving your home.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center space-y-2 pt-2">
            ...
            <p className="text-gray-400 text-md">Join 5,000+ virtual influencers</p>
          </div>
        </div>
      </div>
