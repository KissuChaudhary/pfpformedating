        ...
        <div className="relative z-10 space-y-6">
          <div className="space-y-6">
            ...
            <h1 className="text-4xl sm:text-6xl max-w-4xl mx-auto font-bold leading-[1.1] mb-4 font-[var(--font-inter-tight)]">
              <span className="text-white">AI Instagram Photoshoots That</span>
              ...
              <div key={index} className="min-w-[200px] p-2 relative flex-shrink-0" style={{ padding: '0 10px' }}>
                <div className="relative w-[200px] h-[280px]">
                  ...
                  <div className="absolute bottom-2 left-2 flex items-center gap-[1.5px]">
                    <Image src="/site-logo.png" alt="PFPforME Logo" width={24} height={24} className="w-6 h-6 rounded" />
                  </div>
                </div>
              </div>
            ))}
              ...
              <div key={`first-${index}`} className="w-[200px] p-2 relative flex-shrink-0">
                <div className="relative w-full h-full max-w-[200px] mx-auto aspect-[3/4]">
                  ...
                  <div className="absolute bottom-2 right-2 flex items-center gap-[1px] bg-white/80 rounded text-[10px]">
                    <Image src="/site-logo.png" alt="PFPforME Logo" width={16} height={16} className="w-4 h-4 rounded" />
                    <span className="px-1 py-0.5">AI</span>
                  </div>
                </div>
              </div>
            ))}
